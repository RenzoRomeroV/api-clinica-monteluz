-- ============================================
-- BASE DE DATOS COMPLETA - CLÍNICA MONTELUZ V2
-- PostgreSQL / Supabase
-- ============================================

-- No necesitamos extensiones UUID, usaremos SERIAL para IDs numéricos
...
-- Insertar especialidades de ejemplo (IDs se generan automáticamente: 1, 2, 3, 4, 5, 6, 7, 8)
...
-- Insertar administrador principal (ID se genera automáticamente: 1)
...
-- Insertar medicamentos de ejemplo (IDs se generan automáticamente: 1, 2, 3, 4, 5)
